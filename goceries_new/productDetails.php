    ...
    <div class="small-container" style="margin-top: 80px;">
        <div class = "row">
            ...
            <div style= "flex: 50%; min-width: 180px; margin-bottom: 30px; padding: 20px; ">
                <form  style= "margin-left:98px" method='post' action=''>
                    ...
                    <h1 class="product_name"><?php echo $product['product_name'] ?></h1>
                    <h4 style="margin: 15px 0; font-size: 22px; font-weight: bold;">$ <?php echo $product['product_price'] ?> / each</h4>
                    ...
                    <h3 class="product_description_title">Product Description</h3>
                    <p class="product_description"><?php echo $product['product_description'] ?></p>

                    <div class="stock">
                        <p class="stock_amount" id="stock"><?php echo 'Stock: ' . $_SESSION['tempProductQuantity'][$product_ID] ?></p>
