...
<style>
  ...
  <body style="margin-top:120px !important">
      ...
      if (isset($_POST["shippingfirstname"]) && isset($_POST["shippinglastname"]) && isset($_POST["shippingemail"]) && isset($_POST["shippingaddress"])
        ...
        if ($_POST["shippingfirstname"] && $_POST["shippinglastname"] && $_POST["shippingemail"] && $_POST["shippingaddress"] &&
          ...
          echo '<div class="confirmation">';
            echo '<img class="confirmation_img" src="images/confirm.png" alt""/>';
            echo '<h1 style="margin-top: 10px; margin-left: 20px; margin-bottom: 20px; text-align:center; font-size:25px;">Thank you!</br> Your order has been placed.</h1>';
          echo '</div>';
          ...
          $results = mysqli_query($conn, $sql);
            ...
            forEach($_SESSION['shopping_cart'] as $products){
              ...
              //either use tempProductQuantity SESSION, or the cart SESSION, stock - quantity;
              $sql3 = "INSERT INTO orders_products_details (order_ID, product_ID, order_product_totalweight, order_product_totalquantity) VALUES ($orderid, $productid, $totalweight, $totalquantity)";
              $results3= mysqli_query($conn, $sql3);
          ...
          if ($results && $results2 && $results3) {
            echo '<div style="flex-direction: row-reverse;" class="row">';
              echo '<div class="shipping">';
                echo '<div class="details">';
                echo '<h1 style="text-align:center; margin-top:40px;">Shipping Details</h2>';
                  echo '<span>'.$_POST['shippingfirstname'].' </span>';
                  echo '<span>'.$_POST['shippinglastname'].'</span>';
                  echo '<span>'.$_POST['shippingemail'].'</span>';
                  echo '<span>'.$_POST['shippingaddress'].'</span>';
                  echo '<span>'.$_POST['shippingcity'].',</span>';
                  echo '<span>'.$_POST['shippingstate'].'</span>';
                  echo '<span>'.$_POST['shippingzip'].'</span>';
                echo '</div>';
              echo '</div>';
              ...
              echo '<div class="shipping">';
                echo '<div class="details">';
                  ...
                  echo "<br>";
                  echo '<span><a href="tracking.php">Track Package</a></span>';
                  echo '</div>';
              echo '</div>';
            echo '</div>';
